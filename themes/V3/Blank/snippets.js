		...
		snippets: [
			{
				...
				useImagePicker: true,
				gen: '',
				template: (imageUrl) => `![](${imageUrl}) {width:100%,mix-blend-mode:multiply}`
			},
			{
				...
				useImagePicker: true,
				gen: '',
				template: (imageUrl) => `![](${imageUrl}) {width:80%,margin-right:-3cm,wrapLeft}`
			},
			{
				...
				useImagePicker: true,
				gen: '',
				template: (imageUrl) => `![](${imageUrl}) {width:80%,margin-left:-3cm,wrapRight}`
			},
			{
				...
				useImagePicker: true,
				gen: '',
				template: (imageUrl) => `![](${imageUrl}) {position:absolute,top:50px,right:30px,width:280px}`
			},
			{
			...
			},
			{
				...
				useImagePicker: ImageMaskGen.center.useImagePicker,
				gen: ImageMaskGen.center.gen,
				template: ImageMaskGen.center.template,
				experimental: true,
			},
			{
				name: 'Watercolor Edge',
				icon: 'fac mask-edge',
				useImagePicker: ImageMaskGen.edge('bottom').useImagePicker,
				gen: ImageMaskGen.edge('bottom').gen,
				template: ImageMaskGen.edge('bottom').template,
				experimental: true,
				subsnippets: [
					{
						name: 'Top',
						icon: 'fac position-top',
						useImagePicker: ImageMaskGen.edge('top').useImagePicker,
						gen: ImageMaskGen.edge('top').gen,
						template: ImageMaskGen.edge('top').template,
					},
					{
						name: 'Right',
						icon: 'fac position-right',
						useImagePicker: ImageMaskGen.edge('right').useImagePicker,
						gen: ImageMaskGen.edge('right').gen,
						template: ImageMaskGen.edge('right').template,
					},
					{
						name: 'Bottom',
					...
					},
					{
						...
						useImagePicker: ImageMaskGen.edge('left').useImagePicker,
						gen: ImageMaskGen.edge('left').gen,
						template: ImageMaskGen.edge('left').template,
					},
				]
			},
			{
				...
				useImagePicker: ImageMaskGen.corner().useImagePicker,
				gen: ImageMaskGen.corner().gen,
				template: ImageMaskGen.corner().template,
				experimental: true,
				subsnippets: [
					{
						name: 'Top-Left',
						icon: 'fac position-top-left',
						useImagePicker: ImageMaskGen.corner('top', 'left').useImagePicker,
						gen: ImageMaskGen.corner('top', 'left').gen,
						template: ImageMaskGen.corner('top', 'left').template,
					},
					{
						name: 'Top-Right',
						icon: 'fac position-top-right',
						useImagePicker: ImageMaskGen.corner('top', 'right').useImagePicker,
						gen: ImageMaskGen.corner('top', 'right').gen,
						template: ImageMaskGen.corner('top', 'right').template,
					},
					{
						name: 'Bottom-Left',
						icon: 'fac position-bottom-left',
						useImagePicker: ImageMaskGen.corner('bottom', 'left').useImagePicker,
						gen: ImageMaskGen.corner('bottom', 'left').gen,
						template: ImageMaskGen.corner('bottom', 'left').template,
					},
					{
						name: 'Bottom-Right',
						icon: 'fac position-bottom-right',
						useImagePicker: ImageMaskGen.corner('bottom', 'right').useImagePicker,
						gen: ImageMaskGen.corner('bottom', 'right').gen,
						template: ImageMaskGen.corner('bottom', 'right').template,
					}
				]
			},
			{
